...
//		System.out.println(temp[4]);	// 영업상태 01 정상
//		System.out.println(temp[12]);	// 전화번호
//		System.out.println(temp[15]);	// 지번주소
//		System.out.println(temp[16]);	// 도로명주소
//		System.out.println(temp[18]);	// 사업장명
...
//			System.out.println(data[2]);
			...
			if (data[15].equals("") || data[15] == null) {
				proj = getDataFromKakao(data[16]);
			} else {
				proj = getDataFromKakao(data[15]);
			}
