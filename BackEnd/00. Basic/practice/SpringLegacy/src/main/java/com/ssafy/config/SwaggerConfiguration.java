...
//	http://localhost:8080/{your-app-root}/swagger-ui/index.html
	...
	private String title = "SSAFY 도서관리 API " + version;
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).consumes(getConsumeContentTypes())
				...
				.apis(RequestHandlerSelectors.basePackage("com.ssafy.ws.controller")).paths(regex("/bookapi/.*"))
...
//      consumes.add("application/xml;charset=UTF-8");
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title(title).description("<h3>워크샵 api 문서</h3>")
