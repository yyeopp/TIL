...
public class DynamicProxyBasicConfig {
    ...
    public OrderControllerV1 orderControllerV1(LogTrace logTrace) {
        ...
        return (OrderControllerV1) Proxy.newProxyInstance(OrderControllerV1.class.getClassLoader(), new Class[]{OrderControllerV1.class}, new LogTraceBasicHandler(orderControllerV1, logTrace));
    }
